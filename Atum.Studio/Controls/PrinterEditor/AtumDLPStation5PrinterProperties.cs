...
{
    public partial class AtumDLPStation5PrinterProperties : UserControl
    {
        private AtumDLPStation5 _dataSource;
        ...
        public AtumDLPStation5PrinterProperties()
        {
            InitializeComponent();
        ...
        private void UpdatePrinterSettings()
        {
            ...
            // if (this.atumPrinterCalibration1.IsDirty)
            // {
