...
{
    public class SceneControlToolbarToolTipLeftSide : SceneControlToolbarToolTipBase
    {
        ...
        internal SceneControlToolbarToolTipLeftSide(SceneControlToolbars.SceneControlToolbarBase parentToolbar, PictureBox button)
        {
