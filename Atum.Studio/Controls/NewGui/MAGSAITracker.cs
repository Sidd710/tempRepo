...
namespace Atum.Studio.Controls.NewGui
{
    ...
    ///   </para>
    /// </summary>
    [Designer(typeof(MAGSAITrackerDesigner))]
    [DefaultProperty("Maximum")]
    [DefaultEvent("ValueChanged")]
    public class MAGSAITracker : System.Windows.Forms.Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            Rectangle workingRect = Rectangle.Inflate(this.ClientRectangle, -IndentWidth / 2, -_indentHeight);
            float currentUsedPos = 0;
        ...
        {
            g.FillRectangle(new SolidBrush(Color.FromArgb(255, 204, 204, 204)), drawRect);
        }
        ...
        private void DrawTracker(Graphics g, RectangleF trackerRect)
        {
            ...
            g.FillEllipse(new SolidBrush(Color.Black), trackerRect);
        }
