...
using Atum.DAL.Compression.Zip.Encryption;
#endif

using Atum.DAL.Compression.Zip.Core;
using Atum.DAL.Compression.Zip.Checksums;
using Atum.DAL.Compression.Zip.Compression.Streams;
using Atum.DAL.Compression.Zip.Compression;
using Atum.DAL.Compression.Zip;

namespace Atum.DAL.Compression.Zip 
{
	...
	/// 					Debug.WriteLine("{0, -10}{1, -10}{2}  {3}   {4}", e.Size, e.CompressedSize,
